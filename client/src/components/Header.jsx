...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >Turn text to <span
        className='text-indigo-600'>image</span>, in seconds.</motion.h1>
    ...
    <motion.div className='flex flex-wrap justify-center items-center mt-16 gap-3'
    initial={{opacity: 0}}
    animate={{opacity: 1}}
    ...
    >Generated images from AI-Image Generation</motion.p>
